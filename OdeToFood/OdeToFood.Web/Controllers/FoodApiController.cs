...
namespace OdeToFood.Web.Controllers
{
    public class FoodApiController : Controller
    {
        ...
        {
            var strInfo = new Root();
            string Baseurl = "https://api.edamam.com/api/food-database/v2/parser?session=42&ingr=meat&app_id=bed7de23&app_key=723503d473f80798e6f2bae12c12c4be";
            ...
            using (var client = new HttpClient())
            {
                ...
                if (responseMessage.IsSuccessStatusCode)
                {
                    ...
                    strInfo = JsonConvert.DeserializeObject<Root>(strResponse, jsonSerializerSettings);
                }
            }
            return View(strInfo);
